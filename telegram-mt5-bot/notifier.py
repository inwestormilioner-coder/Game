"""Sends Telegram notifications (one per ZONE signal, plus the daily
summary) using the SAME logged-in Telethon session that reads the signal
channel (see telegram_listener.py) - no separate Telegram bot/token needed.
